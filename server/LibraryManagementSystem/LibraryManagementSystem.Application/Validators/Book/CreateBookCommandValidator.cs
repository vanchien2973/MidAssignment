...
namespace LibraryManagementSystem.Application.Validators.Book
{
    public class CreateBookCommandValidator : AbstractValidator<CreateBookCommand>
    {
        ...
        public CreateBookCommandValidator(IBookRepository bookRepository, ICategoryRepository categoryRepository)
        {
        ...
        private async Task<bool> IsbnMustBeUnique(string isbn, CancellationToken cancellationToken)
        {
